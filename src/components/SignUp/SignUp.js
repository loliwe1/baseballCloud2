    ...
    <div className="modal-signUp">
      <header className="modal-signUp__header">
        <div className="modal-signUp__toggle-block">
          <button type="button" className="modal-signUp__btn modal-signUp__btn--player modal-btn-checked">
          ...
          <button type="button" className="modal-signUp__btn modal-signUp__btn--scout">
