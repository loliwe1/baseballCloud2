    ...
    <div className="profile-create__container">
      ...
      <div>
        <div className="profile-create">
          Changing your profile options lets you control how others see you and your profile.
          These settings include things like your name, personal info and school.
        </div>
      </div>
    </div>
  </div>
